...
\todo{Alternative approaches to parsing: named entity recognition, statistical parsers.}
...
\todo{How many PEG rules did you create? Please provide a set of sample rules and discuss}
...
\todo{It's not very clear what the evaluation data actually was}
...
\vspace{0.5cm}
\todo{Explain examples where GBIF parser failed in more detail}
\begin{verbatim}
    Crataegus chlorosarca subtaxon pubescens E.L.Wolf
      (could not parse two instances of intraspecific epethets)
    Erigeron peregrinus ssp.callianthemus var. eucallianthemus
      (could not parse two instances of infraspecific epithets)
